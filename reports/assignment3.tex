...
This assignment explores the implementation and optimization of a convolutional  neural network for image classification on the CIFAR-10 dataset. We investigate several key aspects of neural network training, including gradient computation, cyclic learning rates, regularization techniques, and optimization methods.
